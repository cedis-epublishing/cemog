{**
 * plugins/generic/cemog/templates/contactFormModified.tpl
 *
...
<form class="pkp_form" id="contactForm" method="post" action="{url op="saveContact"}">
	...
	{fbvFormSection}
		...
		{else}
			{fbvElement type="textarea" label="common.mailingAddress" name="mailingAddress" id="mailingAddress" rich=false value=$mailingAddress size=$fbvStyles.size.LARGE}
		{/if}
